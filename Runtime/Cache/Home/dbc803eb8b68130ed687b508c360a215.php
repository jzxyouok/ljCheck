...
<body>
    ...
    <span>位置：</span>
    <ul class="placeul">
    <li><a href="/ljCheck/index.php/Index/staffList">首页</a></li>
    <li><a href="#">员工列表</a></li>
    </ul>
    </div>
    ...
    <table class="tablelist">
        ...
        <th>编号<i class="sort"><img src="<?php echo (PUBLIC_URL); ?>/images/px.gif" /></i></th>
        <th>标题</th>
        <th>用户</th>
        <th>籍贯</th>
        <th>发布时间</th>
    ...
    <div class="tip">
      ...
      <div class="tipinfo">
        <span><img src="<?php echo (PUBLIC_URL); ?>/images/ticon.png" /></span>
        <div class="tipright">
        <p>是否确认对信息的修改 ？</p>
