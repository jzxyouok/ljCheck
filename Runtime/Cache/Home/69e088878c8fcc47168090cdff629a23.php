...
<div id="staffList" style="width: 85%;float: left;padding-left: 15%">
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="<?php echo U('Check/overWorkList');?>">加班数据</a></li>
        </ul>
    </div>

    <div class="formbody">
        <ul class="seachform">
            <li><label>姓名</label><input id="overWorkList_name" type="text" class="scinput" value="<?php echo ($staff_name); ?>"/></li>
            <li><label>部门</label>
                <div class="vocation">
                    <select class="select3" id="overWorkList_department">
            ...
            <li><label>日期(默认上一个月的数据)</label>
                <input id="overWorkList_year_month" type="text" class="Wdate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM'})" style="width: 100px;height: 28px; padding-left: 10px;" value="<?php echo ($year_month); ?>"/>
            </li>

            <li><label>&nbsp;</label><input id="overWorkList_btn_search" type="button" class="scbtn" value="查询"/></li>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["is_festival"]); ?></td>
                    <td><?php echo ($vo["over_start_time"]); ?></td>
                    <td><?php echo ($vo["over_end_time"]); ?></td>
                    <td><?php echo ($vo["over_hours"]); ?></td>
                    <td><?php echo ($vo["overtime_pay"]); ?></td>
                    <td><?php echo ($vo["over_reason"]); ?></td>

                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
        <input id="overWorkList_pageNum" style="display: none" value="<?php echo ($pageNum); ?>"/>
        <div class="pagination" id="page_overWorkList"></div>
    </div>
</div>
<!--页脚-->
...
<script>
    laypage({
        cont: 'page_overWorkList',
        pages: $('#overWorkList_pageNum').val(), //可以叫服务端把总页数放在某一个隐藏域，再获取。假设我们获取到的是18
