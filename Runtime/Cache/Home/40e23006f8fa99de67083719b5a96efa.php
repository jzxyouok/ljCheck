...
<div id="staffList" style="width: 85%;float: left;padding-left: 15%">
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="<?php echo U('Check/signList');?>">签到数据</a></li>
        </ul>
    </div>

    <div class="formbody">
        <ul class="seachform">
            <li><label>姓名</label><input id="signList_name" type="text" class="scinput" value="<?php echo ($staff_name); ?>"/></li>
            <li><label>部门</label>
                <div class="vocation">
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php if($vo["sign_in_time"] == null ): ?>未签到 <?php else: ?> <?php echo ($vo["sign_in_time"]); endif; ?></td>
                    <td><?php if($vo["sign_out_time"] == null ): ?>未签退 <?php else: ?> <?php echo ($vo["sign_out_time"]); endif; ?></td>
                    <td><?php if($vo["late_time"] == null ): ?>0<?php else: echo ($vo["late_time"]); endif; ?></td>
                    <td><?php if($vo["early_time"] == null ): ?>0<?php else: echo ($vo["early_time"]); endif; ?></td>
                    <td><?php if($vo["is_out_work"] == null ): ?>否<?php else: ?>是<?php endif; ?></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
        <input id="signList_pageNum" style="display: none" value="<?php echo ($pageNum); ?>"/>
