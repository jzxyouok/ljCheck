...
<div id="staffList" style="width: 85%;float: left;padding-left: 15%">
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="<?php echo U('Check/repSignList');?>">补签数据</a></li>
        </ul>
    </div>

    <div class="formbody">
        <ul class="seachform">
            <li><label>姓名</label><input id="repSignList_name" type="text" class="scinput" value="<?php echo ($staff_name); ?>"/></li>
            <li><label>部门</label>
                <div class="vocation">
            ...
            <li><label>日期(默认上一个月的数据)</label>
                <input id="repSignList_year_month" type="text" class="Wdate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM'})" style="width: 100px;height: 28px; padding-left: 10px;" value="<?php echo ($year_month); ?>"/>
            </li>
        ...
        <table class="tablelist">
            ...
            <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                    ...
                    <td><?php echo ($vo["rep_sign_time"]); ?></td>
                </tr><?php endforeach; endif; else: echo "" ;endif; ?>
            </tbody>
        </table>
        <input id="repSignList_pageNum" style="display: none" value="<?php echo ($pageNum); ?>"/>
