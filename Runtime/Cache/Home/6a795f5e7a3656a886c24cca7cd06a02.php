...
<div id="staffList" style="width: 85%;float: left;padding-left: 15%">
    <div class="place">
        ...
        <ul class="placeul">
            ...
            <li><a href="<?php echo U('Check/leaveList');?>">请假数据</a></li>
        </ul>
    </div>

    <div class="formbody">
        <ul class="seachform">
            <li><label>姓名</label><input id="leaveList_name" type="text" class="scinput" value="<?php echo ($staff_name); ?>"/></li>
            <li><label>部门</label>
                <div class="vocation">
            ...
            <li><label>日期(默认上一个月的数据)</label>
                <input id="leave_year_month" type="text" class="Wdate" onFocus="WdatePicker({lang:'zh-cn',dateFmt:'yyyy-MM'})" style="width: 100px;height: 28px; padding-left: 10px;" value="<?php echo ($year_month); ?>"/>
            </li>
        ...
        <input id="leaveList_pageNum" style="display: none" value="<?php echo ($pageNum); ?>"/>
